            ...
            <div class='overflow-x-auto w-full hidden lg:block'>
                <table class='mx-auto mt-12 w-full rounded-lg bg-white divide-y divide-gray-300 overflow-hidden'>
                    ...
                    <tr class="text-white text-left">
                        ...
                        <th class="font-semibold text-sm uppercase px-6 py-4 text-center" v-if="hasAnyPermission(['update category'])">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <tr v-for="category in categories">
                            ...
                            <td class="text-center" v-if="hasAnyPermission(['update category'])">
