...
<!--                            <label :for="this.ids.select" class="block mb-2 mr-3 text-sm font-medium text-gray-400">Wybierz kategorię</label>-->
...
<!--                        </div>-->
                        ...
                        <div class="group flex items-center gap-3" v-for="(input,k) in form.answers" :key="k">
                            <div class="flex items-center mt-2" @click="remove(k)" v-show="k || ( !k && form.answers.length > 1)">
